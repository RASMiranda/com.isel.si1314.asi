...
call Ex1.c.0.Run-Ex1Cliente.c.0.bat
...
call Ex1.c.1.Run-Ex1.c-AsAdmin.bat

call Ex1.c.1.Run-Ex1Cliente.c.1.bat
...
taskkill /f /fi "pid gt 0" /im Ex1Cliente.c.0.exe

taskkill /f /fi "pid gt 0" /im Ex1Cliente.c.1.exe
...
taskkill /f /fi "pid gt 0" /im Ex1Cliente.c.0.vshost.exe

taskkill /f /fi "pid gt 0" /im Ex1Cliente.c.1.vshost.exe
